...
import com.appaholics.email.NotificationController;
import com.appaholics.email.Controller.ControllerService;
...
public class AttachmentDownloadService extends Service implements Runnable {
    ...
    private static final String EXTRA_ATTACHMENT =
        "com.appaholics.email.AttachmentDownloadService.attachment";
