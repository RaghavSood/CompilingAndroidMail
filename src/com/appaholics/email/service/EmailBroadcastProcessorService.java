...
import com.appaholics.email.SecurityPolicy;
...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    private static final String ACTION_DEVICE_POLICY_ADMIN = "com.appaholics.email.devicepolicy";
    ...
    /**
     * Entry point for {@link com.appaholics.email.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * com.appaholics.email.SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
