...
import com.appaholics.email.Preferences;
import com.appaholics.email.SingleRunningTask;
import com.appaholics.email.provider.AccountReconciler;
...
public class MailService extends Service {
    ...
    private static final String ACTION_CHECK_MAIL =
        "com.appaholics.email.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESCHEDULE =
        "com.appaholics.email.intent.action.MAIL_SERVICE_RESCHEDULE";
    private static final String ACTION_CANCEL =
        "com.appaholics.email.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_SEND_PENDING_MAIL =
        "com.appaholics.email.intent.action.MAIL_SERVICE_SEND_PENDING";
    private static final String ACTION_DELETE_EXCHANGE_ACCOUNTS =
        "com.appaholics.email.intent.action.MAIL_SERVICE_DELETE_EXCHANGE_ACCOUNTS";

    private static final String EXTRA_ACCOUNT = "com.appaholics.email.intent.extra.ACCOUNT";
    private static final String EXTRA_ACCOUNT_INFO = "com.appaholics.email.intent.extra.ACCOUNT_INFO";
    private static final String EXTRA_DEBUG_WATCHDOG = "com.appaholics.email.intent.extra.WATCHDOG";
