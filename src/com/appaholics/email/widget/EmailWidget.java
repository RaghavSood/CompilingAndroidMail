...
package com.appaholics.email.widget;
...
import com.appaholics.email.ResourceHelper;
import com.appaholics.email.activity.MessageCompose;
import com.appaholics.email.activity.UiUtilities;
import com.appaholics.email.activity.Welcome;
import com.appaholics.email.provider.WidgetProvider.WidgetService;
...
public class EmailWidget implements RemoteViewsService.RemoteViewsFactory,
     ...
     */
    private static final String WIDGET_DATA_MIME_TYPE = "com.appaholics.email/widget_data";
    ...
    /**
     * Called back by {@link com.appaholics.email.provider.WidgetProvider.WidgetService} to
