...
public class EmailServiceProxy extends ServiceProxy implements IEmailService {
    ...
    public static final String EXCHANGE_INTENT = "com.appaholics.email.EXCHANGE_INTENT";
    public static final String IMAP_INTENT = "com.appaholics.email.IMAP_INTENT";
